...
func newSysUser(db *gorm.DB, opts ...gen.DOOption) sysUser {
	...
	_sysUser.Gender = field.NewInt16(tableName, "gender")
	_sysUser.Head = field.NewString(tableName, "head")
	_sysUser.Remark = field.NewString(tableName, "remark")
	_sysUser.State = field.NewInt16(tableName, "state")
	_sysUser.DepartmentID = field.NewInt64(tableName, "department_id")
	_sysUser.RoleID = field.NewInt64(tableName, "role_id")
	_sysUser.Eamil = field.NewString(tableName, "eamil")
...
type sysUser struct {
	...
	Salt         field.String
	Phone        field.String
	Gender       field.Int16 // 性别，0：女，1：男，默认1
	Head         field.String
	Remark       field.String
	State        field.Int16 // 状态，0：禁用，1：启用，2：锁定
...
func (s *sysUser) updateTableName(table string) *sysUser {
	...
	s.Head = field.NewString(table, "head")
	...
	s.Eamil = field.NewString(table, "eamil")
